...
extension MILoader {
    ...
    static let circularView:UIView = {
    ...
    fileprivate static let firstLayer:CAShapeLayer = {
        ...
        firstLayer.strokeColor = UIColor.blue.cgColor
    ...
    fileprivate static let secondLayer:CAShapeLayer = {
        ...
        secondLayer.strokeColor =  UIColor.blue.cgColor
...
extension MILoader {
    ...
    static func startCircularRingAnimation() {
...
extension MILoader {
    ...
    private func resizeGifLoader() {
        ...
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .top, relatedBy: .equal, toItem: MILoader.containView, attribute: .top, multiplier: 1.0, constant: 0.0).isActive = true
        
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .leading, relatedBy: .equal, toItem: MILoader.containView, attribute: .leading, multiplier: 1.0, constant: 0.0).isActive = true
        
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .trailing, relatedBy: .equal, toItem: MILoader.containView, attribute: .trailing, multiplier: 1.0, constant: 0.0).isActive = true
        
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .bottom, relatedBy: .equal, toItem: MILoader.containView, attribute: .bottom, multiplier: 1.0, constant: 0.0).isActive = true
...
extension MILoader {
    ...
    func showLoader(type:MILoaderType , message:String?) {
        ...
        setCircularRingBorderColor(color:ColorAppTheme)
