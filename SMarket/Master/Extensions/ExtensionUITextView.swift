...
extension UITextView : UITextViewDelegate {
    ...
    // Char limit of textview
    private struct AssociatedObjectKey {
        static var charLimit = "charLimit"
    }
    
    var charLimit:Int? {
        get {
            if let charLimit = objc_getAssociatedObject(self, &AssociatedObjectKey.charLimit) as?  Int {
                return charLimit
            }
            return nil
        }
    ...
    func setCharLimit(charLimit:Int) {
        
        objc_setAssociatedObject(self, &AssociatedObjectKey.charLimit, charLimit, .OBJC_ASSOCIATION_RETAIN)
    }
