...
extension UITextField {
    ...
    func addLeftImage(strImgName:String? , padding:CGFloat?, imageContentMode:imageContentMode) {
        ...
        let leftImageView = (strImgName == nil || strImgName?.count == 0) ? UIImageView() : UIImageView(image: UIImage(named: strImgName ?? ""))
    ...
    func addRightImage(strImgName:String? , padding:CGFloat?, imageContentMode:imageContentMode) {
        ...
        let rightImageView = (strImgName == nil || strImgName?.count == 0) ? UIImageView() : UIImageView(image: UIImage(named: strImgName ?? ""))
...
extension UITextField {
    ...
    func setDatePickerWithDateFormate(dateFormate:String , defaultDate:Date? , isPrefilledDate:Bool , selectedDateHandler:
        @escaping selectedDateHandler) {
...
extension UITextField : UIPickerViewDataSource , UIPickerViewDelegate {
    ...
    func setPickerData(arrPickerData:[Any] , selectedPickerDataHandler:
        @escaping selectedPickerDataHandler , defaultPlaceholder:String?) {
...
extension UITextField {
    ...
    func valueChangedEvent(genericValueChangedHandler:
        @escaping genericValueChangedHandler<UITextField>) {
