...
//  Master
//
//  Created by Mac-00014 on 08/06/18.
...
extension RatingView {
    ...
    func setRating(_ rating :  Float) {
        self.emptyImage = UIImage(named: "empty_star")
       
        self.fullImage = UIImage(named: "full_star")
    ...
    func setRating(_ rating :  Float, isEditable:Bool) {
        
        if self.tag == 100 {
            self.emptyImage = UIImage(named: "starbig")
            self.fullImage = UIImage(named: "full_star")
